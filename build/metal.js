...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $feed(opt_data, opt_ignored, opt_ijData) {
      ...
      for (var postIndex22 = 0; postIndex22 < postListLen22; postIndex22++) {
        ...
        ie_open('li');
        ie_open('a', null, null, 'href', postData22.data.url);
  ...
  var RedditFeed = function (_Component) {
    babelHelpers.inherits(RedditFeed, _Component);

    function RedditFeed() {
      babelHelpers.classCallCheck(this, RedditFeed);
      return babelHelpers.possibleConstructorReturn(this, (RedditFeed.__proto__ || Object.getPrototypeOf(RedditFeed)).apply(this, arguments));
    }
  ...
  this['metalNamed']['RedditFeed'] = this['metalNamed']['RedditFeed'] || {};
  this['metalNamed']['RedditFeed']['RedditFeed'] = RedditFeed;
  this['metalNamed']['RedditFeed']['templates'] = templates;
  this['metal']['RedditFeed'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
	var Component = this['metal']['component'];
	var Soy = this['metal']['Soy'];
	var templates = this['metal']['RedditFeed'];
	...
	var RedditFeed = function (_Component) {
		...
		babelHelpers.createClass(RedditFeed, [{
			key: 'created',
			value: function created() {
				this.fetchFeed();
			...
			value: function handleRequest(request) {
				if (request.readyState === 4) {
					if (request.status === 200) {
						...
						this.responseFailure(request);
					}
				}
			}
		}, {
			key: 'handleTypeClick',
			value: function handleTypeClick(event) {
			...
			key: 'responseFailure',
			value: function responseFailure(request) {
				this.error = request.status + ' ' + request.statusText;
			}
		}, {
			key: 'responseSuccess',
			value: function responseSuccess(request) {
				this.error = null;
	...
	this['metal']['RedditFeed'] = RedditFeed;
}).call(this);
}).call(this);
